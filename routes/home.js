...
module.exports = function (async, gpNames, Users, Message, FriendResult, upload, Uvalid) {
    return {
        SetRouting: function (router) {
            router.get("/home", Uvalid.userAuthenticated, this.homePage); 
        ...
        homePage: function (req, res) {
            ...
            async.parallel([ //allow each function that be added to run in parallel
              ...
              // 
                 ...
                 res.render('travel/home', {title: 'GPchat - Home', user:req.user, chunks: dataChunk, data: res2, chat: res4});
            })
